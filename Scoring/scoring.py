...
#tika.TikaClientOlny = True
pdf_file = "C:\\capston\\paper\\pdf\\P1.pdf"
doc = parser.from_file(pdf_file, xmlContent=True)  # 인풋 파일의 절대경로로 수정
doc = doc["content"]
'''
import PyPDF2

pdf_file = open("C:\\capston\\paper\\pdf\\p7.pdf", "rb")
...
train = pd.read_csv(r'C:\capston\test\mapping.csv')
